...
namespace HotelBooking.Controllers
{
    ...
    public class BillController : Controller
    {
        ...
        public async Task<IActionResult> GeneratePDF(Guid billId)
        {
            ...
            string HtmlContent = "<h1  style=\"text-align: center;\">Welocme to Grand's Hotel</h1>";
            HtmlContent += "<p style=\"text-align: center;\">1/187,Marathahalli,Banglore-560037,Karnataka</p>";
           var header = await this.billRepository.GetBillAsync(billId);
            //if(header!=null)
            //{
            //    HtmlContent += "<h3>Bill Number: " + header.BillId +"</h3>";
            //    HtmlContent += "<h3>CheckIn Date: " + header.CheckinDate + "</h3>";
            //    HtmlContent += "<h3>CheckOut Date: " + header.CheckoutDate + "</h3>";
            //    HtmlContent += "<h3>Tax Amount: " + header.TaxAmount + "</h3>";
            //    HtmlContent += "<h3>Total Amount: " + header.TotalAmount + "</h3>";
            //}
            if (header != null)
            {
